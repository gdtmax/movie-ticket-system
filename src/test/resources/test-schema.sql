...
CREATE TABLE IF NOT EXISTS seats (
    ...
    FOREIGN KEY (theater_id) REFERENCES theaters (id) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    FOREIGN KEY (showtime_id) REFERENCES showtimes (id) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS booking_seats (
    ...
    FOREIGN KEY (showtime_id) REFERENCES showtimes (id) ON UPDATE CASCADE ON DELETE RESTRICT,
    FOREIGN KEY (seat_id) REFERENCES seats (id) ON UPDATE CASCADE ON DELETE RESTRICT
);
...
FOR EACH ROW
WHEN (SELECT theater_id FROM seats WHERE id = NEW.seat_id)
